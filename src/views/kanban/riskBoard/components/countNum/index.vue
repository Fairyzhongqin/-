<template>
  <div class="d-roll-wrapper">
    <ul ref="list"
        class="d-roll-list">
      <li v-for="(item, i) of digitOffsetArr"
          :key="i"
          class="d-roll-item"
          :style="{ height: `${cellHeight}px` }">
        <div class="d-roll-bar"
             v-html="innerUnitHtml"
             :style="getliStyle(item, i)"></div>
      </li>
    </ul>
  </div>
</template>
...
<script>
// https://github.com/gitWhatever/vue-digitroll 滚动数字
import Tween from '@tweenjs/tween.js'
import { easeToCubicMap, arrayFromCache, getHeight, supportCssCache, callExp } from './util'
...
.d-roll-wrapper {
  ...
  .d-roll-item {
    ...
    box-shadow: 0px 2px 4px 0px rgba(6, 12, 24, 0.8);
    border-radius: 4px;
    width: 34px;
  ...
  .d-roll-item > .d-roll-bar > div {
    ...
    font-weight: bold;
    background-image: -webkit-linear-gradient(bottom, #00c6ff, #dcf3ff);
