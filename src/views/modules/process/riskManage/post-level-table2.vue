    ...
    <el-table :data="dataList"
      ...
      <el-table-column :show-overflow-tooltip="true"
        ...
        <template slot-scope="scope">
          {{scope.row.judgedWorkshop}} {{scope.row.judgedPost || scope.row.judgedTeam}}
        </template>
      </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 查看记录
      viewRecord (id) {
        this.$router.push({ path: '/process/riskManage/safety-risk-assessment-detailed', query: {id: id, preview: '3', level: '2'} })
      },
      // 每页数
