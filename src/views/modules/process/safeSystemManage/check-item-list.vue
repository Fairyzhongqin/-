<!--检查项列表  -->
<template>
  <div class="check-item-list-container mod-config">
    <el-form :inline="true" :model="dataForm" ref="dataForm">
      <el-form-item label="检查项名称" prop="itemName">
        <el-input v-model="dataForm.itemName" class="check" placeholder="检查项名称" clearable></el-input>
      </el-form-item>
    ...
    <el-table :data="dataList" border ref="multipleTable" @cell-click="cellClick" v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column label="检查项名称" prop="itemName" :show-overflow-tooltip="true" with="180">
      </el-table-column>
      <el-table-column label="检查项类型" prop="itemType" :show-overflow-tooltip="true" with="120" header-align="center" align="center">
...
import addOrUpdate from './check-item-add-or-update'
export default {
  components: {
    addOrUpdate
  },
