  ...
  <div class="emergency-plan-container mod-config">
    <el-form :inline="true" ref="dataForm" class="el-form-margin-bottom" :model="dataForm" @submit.native.prevent @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <!-- <el-button type="warning" size="mini" @click="addOrUpdateHandle()">新增</el-button>
    ...
    <el-table :data="dataList" border @cell-click="cellClick" ref="multipleTable" v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <!-- <el-table-column prop="planInfo" :show-overflow-tooltip="true" label="发生时间"> -->
      <!-- </el-table-column> -->
      ...
      <el-table-column :show-overflow-tooltip="true" label="事故涉及人" min-width="100" max-width="130">
        <template slot-scope="scope">
          {{handle(scope.row.involveEmployee)}}
        </template>
      </el-table-column>
      <el-table-column prop="jobDescription" :show-overflow-tooltip="true" label="工作描述" min-width="85">
      </el-table-column>
