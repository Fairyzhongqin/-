<!--从业人员培训-->
<template>
  <div class="train-other-style mod-config">
    <el-form :inline="true" ref="dataForm" class="el-form-margin-bottom" :model="dataForm" @submit.native.prevent @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button type="warning" size="mini" @click="addOrUpdateHandle('qt')" icon="el-icon-plus" v-waves>上传资料</el-button>
      ...
      <el-table :data="dataList" border @cell-click="cellClick" ref="multipleTable" v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="min-width: 100%;">
        ...
        <el-table-column label="操作" width="180">
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" @click.stop="addOrUpdateHandle('qt',scope.row.id)">修改</el-button>
...
export default {
  ...
  methods: {
    ...
    selectTrainType () {
      this.trainData = []
      traintypeList({ trainType: '4' }).then(({ data }) => {
        if (data && data.code === 0) {
