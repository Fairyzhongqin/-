<template>
  <el-dialog :title="(!dataForm.id ? '新增' : '查看') + '罐区'" :close-on-click-modal="false" :visible.sync="visible" width="50%" class="tankEdit-dialog">
    <div>
      <el-row>
        <el-col :span="24">
          <!-- 添加内容位置 -->
          <el-form :model="dataForm" ref="dataForm" class="pr20" label-width="120px">
            ...
            <el-form-item label="罐区编号" prop="code">
              <el-input v-model="dataForm.code" :disabled="true" :readonly="true" placeholder="罐区编号" maxlength="20" clearable></el-input>
            </el-form-item>
            <el-form-item label="罐区名称" prop="name">
              <el-input v-model="dataForm.zoneName" placeholder="罐区名称" maxlength="60" disabled clearable></el-input>
            </el-form-item>
            ...
            <el-form-item label="风险属性" prop="dangerAttr">
              <el-input v-model="dataForm.dangerAttr" placeholder="风险属性" maxlength="60" disabled clearable></el-input>
            </el-form-item>
            <el-form-item label="储罐最小间距/m" prop="spacing">
              <el-input v-model="dataForm.spacing" placeholder="储罐最小间距/m" maxlength="10" disabled clearable></el-input>
            </el-form-item>
            <el-form-item label="防护堤数据" prop="dyke">
              <el-input v-model="dataForm.dyke" placeholder="防护堤数据" maxlength="30" disabled clearable></el-input>
            </el-form-item>
            ...
            <el-form-item label="风险属性" prop="acreage">
              <el-input v-model="dataForm.tankNumber" placeholder="风险属性" maxlength="20" disabled clearable></el-input>
            </el-form-item>
            <el-form-item label="描述" prop="acreage">
