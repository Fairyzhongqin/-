...
export default {
  ...
  methods: {
    async init (personIds, select) {
      console.log(this.personIds)
      this.innerVisible = true
      this.dataForm.cgformId = personIds
      await this.getDataList(personIds) // 获取数据列表
    ...
    addStaff () {
      ...
      // console.log(this.selectChange, '选中的人员')
