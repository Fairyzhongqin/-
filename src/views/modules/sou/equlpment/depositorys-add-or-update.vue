<template>
  <el-dialog :title="(!dataForm.id ? '新增' : '修改') + '仓库'"
...
export default {
  ...
  methods: {
    ...
    init (id) {
      ...
      // console.log(this.dataForm.id + '11111')
      ...
      if (id) {
        ...
        repositoryInfo({
          ...
          if (data && data.code === 0) {
            ...
            this.dataForm.reId = data.data.repositoryField.id
          } else {
    ...
    dataFormSubmit () {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          this.visible = false
          this.dataForm.repositoryField.id = this.dataForm.reId
