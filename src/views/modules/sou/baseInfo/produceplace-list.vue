<template>
  <div class='repository-container mod-config'>
    <el-form :inline="true"
      ...
      <el-form-item>
        ...
        <!-- <el-button type="warning"
                   ...
                   icon="el-icon-plus"
                   v-waves
                   @click="addOrUpdateHandle()">新增生产场所</el-button>
    ...
    <el-table :data="dataList"
      ...
      <el-table-column prop="deviceNum"
        ...
        <template slot-scope="scope">
          <span class="reactNum"
                @click.stop="reactListHandle(scope.row.id)">{{scope.row.deviceNum || '0'}}</span></template>
      </el-table-column>
    ...
    <!-- 查看反应装置列表 -->
    <react-list v-if='reactListVisible'
                ref='reactListRef'></react-list>
  </div>
</template>
...
import reactList from './produceplace-react-list'
