<template>
  <el-dialog :title="(!dataForm.id ? '新增' : '修改') + '生产场所'"
      ...
      <el-row>
        <el-col :span="24">
          ...
          <el-form :model="dataForm"
            ...
            <!-- <el-form-item label="反应装置个数"
                          prop="reactorNumber">
              <el-input v-model="dataForm.reactorNumber"
                        placeholder="反应装置个数"
                        maxlength="20"
                        clearable></el-input>
            </el-form-item> -->
            <el-form-item label="固定资产总值"
                          prop="assets">
              <el-input v-model="dataForm.assets"
                        placeholder="固定资产总值"
                        maxlength="10"
                        clearable></el-input>
            </el-form-item>
            ...
            <el-form-item label="单元内危险化学品"
                          prop="dangerThings">
              <el-input v-model="dataForm.dangerThings"
            ...
            <el-form-item label="目标产物"
                          prop="targetProduct">
              <el-input v-model="dataForm.targetProduct"
                        placeholder="目标产物"
                        maxlength="20"
                        clearable></el-input>
            </el-form-item>
...
<script>
import { produceplaceAdd, produceplaceInfo, getZoneInfo, queryRepositoryCode, queryTankFieldCode, queryProducePlaceCode } from '@/api/sou/baseInfo'
  ...
  methods: {
    ...
    dataFormSubmit () {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          this.visible = false
          produceplaceAdd(this.dataForm).then(({ data }) => {
            if (data && data.code === 0) {
