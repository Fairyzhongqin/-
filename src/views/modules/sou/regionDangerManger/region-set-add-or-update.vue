<template>
  <el-dialog title="设置"
    ...
    <el-form :model="dataForm"
      ...
      <el-form-item label="存储化学物品名称"
                    v-if="dataForm.sourType === '1'"
                    prop="storageGood">
        <el-input size="mini"
                  maxlength="30"
                  class="size-mini-pople-input"
      ...
      <el-form-item label="存储化学物品数量"
                    v-if="dataForm.sourType === '1'"
                    prop="storageNum">
        <el-input size="mini"
                  maxlength="30"
                  class="size-mini-pople-input"
                  v-model="dataForm.storageNum"
                  placeholder="存储化学物品数量"
                  clearable></el-input>
      </el-form-item>

      <el-form-item label="装置数"
                    v-if="dataForm.sourType === '2'"
                    prop="deviceNum">
        <el-input size="mini"
                  maxlength="30"
                  type="number"
      ...
      <el-form-item label="储罐数"
                    v-if="dataForm.sourType === '3'"
                    prop="tankNum">
        <el-input size="mini"
                  type="number"
                  maxlength="30"
                  class="size-mini-pople-input"
                  v-model="dataForm.tankNum"
                  placeholder="储罐数"
                  clearable></el-input>
      </el-form-item>
      <el-form-item label="储罐最小间距"
                    v-if="dataForm.sourType === '3'"
                    prop="spacing">
        <el-input size="mini"
                  maxlength="30"
