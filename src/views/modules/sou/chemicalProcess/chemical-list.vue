<template>
  <div class='highrisk-type mod-config'>
    ...
    <el-table :data="dataList"
      ...
      <el-table-column prop="monitorParam"
                       min-width="150"
                       :show-overflow-tooltip="true"
                       label="监测预警参数">
      </el-table-column>
...
<script>
import addOrUpdate from './chemical-add-or-update'
import waves from '@/utils/waves'
import { highRiskProcessTypeList, processTypeDelete } from '@/api/sou/highRisk'
