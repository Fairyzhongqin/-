<template>
  <div class="map-region-edit-container">
    <el-scrollbar class="default-scrollbar" style="height:calc(100vh - 158px)" wrap-class="default-scrollbar__wrap" view-class="p20-scrollbar__view">
      <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="100px">
        ...
        <el-form-item label="上级区域" prop="parentName">
          <el-popover ref="menuListPopover" placement="bottom" width="240" trigger="click" popper-class="region-el-popover high">
          ...
          <el-input v-model="dataForm.parentName" v-popover:menuListPopover :readonly="true" size="mini" class="size-mini-pople-input menu-list__input" placeholder="点击选择上级菜单"></el-input>
        </el-form-item>
        <el-form-item label="绑定围栏" prop="dataListSelections">
          ...
          <el-pagination @size-change="sizeChangeHandle" :pager-count="3" @current-change="currentChangeHandle" :current-page="pageIndex" :page-sizes="[10, 20, 50, 100]" :page-size="pageSize" :total="totalPage" layout="prev, pager, next">
          </el-pagination>
          <div class="personAdd">
      ...
      queryZoneInfo().then(({ data }) => {
        ...
        if (info && info.id) {
          ZoneInfo({ id: info.id }).then(({ data }) => {
            ...
            console.log(this.dataForm.dataListSelections)
