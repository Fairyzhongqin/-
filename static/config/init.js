...
(function () {
  var resList = {
    ...
    js: [
      ...
      // 插件 - ueditor
      window.SITE_CONFIG.cdnUrl + '/static/plugins/umeditor/themes/default/css/umeditor.css',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/umeditor/third-party/jquery.min.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/umeditor/umeditor.config.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/umeditor/umeditor.min.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/umeditor/lang/zh-cn/zh-cn.js',
      // 业务
